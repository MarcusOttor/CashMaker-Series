...
class AdcolonyVideo {
    ...
    fun init(activity: Activity) {
        AdColony.configure(activity, "appc38e405506ed4af995", "vz43341ae37efe42f89d")
    ...
    fun onResume(activity: Activity) {
        if (adcolonyVideo == null || adcolonyVideo!!.isExpired) {
            AdColony.requestInterstitial("vz43341ae37efe42f89d",
                ...
                override fun onExpiring(ad: AdColonyInterstitial?) {
                    super.onExpiring(ad)
                    AdColony.requestInterstitial("vz43341ae37efe42f89d", this)
                }
            })
        }
    }
